...
router.get('/', function (req, res, next) {
    const squelQuery = squel_1.default.select({ autoQuoteAliasNames: false }).field("*").field("pris/volum", "literspris").field("((alkohol/100*volum)/pris*1000000)", "epk").from("product");
    // Search parameter
    if (req.query.query) {
